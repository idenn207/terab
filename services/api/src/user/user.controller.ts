...
//     const { response, rawRefreshToken, refreshTokenExpMs } = await this.userService.login(body, trustToken, userAgent);
...
//     @Res({ passthrough: true }) res: Response,
//   ): Promise<LoginResponse> {
//     const { response, rawRefreshToken, refreshTokenExpMs } = await this.userService.loginWithBackupCode(body);
//     this.setRefreshTokenCookie(res, rawRefreshToken, refreshTokenExpMs);
//     return response;
//   }
...
//     const { response, rawRefreshToken: newRt, refreshTokenExpMs } = await this.userService.refresh(rawRefreshToken);
...
//     const rawRefreshToken = req.cookies?.[this.REFRESH_TOKEN_COOKIE] as string | undefined;
//     await this.userService.logout(rawRefreshToken);
...
//     const backupCodes = await this.userService.regenerateBackupCodes(user.userId, body.currentPassword);
//     return { backupCodes };
//   }
