...
const navigation = [
  { name: '내 드라이브', href: '/drive', icon: HomeIcon, current: true },
  { name: '최근 파일', href: '/recent', icon: ClockIcon, current: false },
  { name: '공유 파일', href: '/shared', icon: ShareIcon, current: false },
  { name: '즐겨찾기', href: '/favorites', icon: StarIcon, current: false },
  { name: '휴지통', href: '/trash', icon: TrashIcon, current: false },
];
...
export function DrivePage() {
   ...
   */}
      <div>
        <Headless.Dialog open={sidebarOpen} onClose={setSidebarOpen} className="relative z-50 lg:hidden">
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:block lg:w-20 lg:overflow-y-auto lg:bg-gray-900 lg:pb-4 dark:before:pointer-events-none dark:before:absolute dark:before:inset-0 dark:before:border-r dark:before:border-white/10 dark:before:bg-black/10">
          <div className="relative flex h-16 shrink-0 items-center justify-center">
            <img alt="Profile" src={LogoUrl} className="h-8 w-auto" />
          </div>
